...
class AutoBindModuleSingletonsTest extends AbstractAutoModuleTest {
	...
	void nested(boolean instantiate, boolean explicitBinding, boolean childInjector, boolean postConstruct) {
		...
		assertAll(
				...
				() -> assertThat(shell).extracting("singleton5.count").isEqualTo(count2),
				() -> assertThat(shell).extracting("singleton5.singleton4").isSameAs(shell.singleton4),
				() -> assertThat(shell).extracting("singleton5.singleton4.count").isEqualTo(count2),
				() -> assertThat(shell).extracting("singleton5.singleton4.singleton3.count").isEqualTo(count1),
				() -> assertThat(shell).extracting("singleton5.singleton4.singleton3.singleton2.count")
						.isEqualTo(count1),
				() -> assertThat(shell).extracting("singleton5.singleton4.singleton3.singleton2.singleton1.count")
						.isEqualTo(count1),
